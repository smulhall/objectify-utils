...
First, download the latest <a href="https://github.com/sappenin/objectify-utils/archive/1.0.4.zip">objectify-utils-1.0.5.jar</a> and include it your application's classpath.
